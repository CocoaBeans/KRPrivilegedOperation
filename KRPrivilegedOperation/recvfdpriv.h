...
#ifndef	_MM_RECVFDPRIV_H
#define	_MM_RECVFDPRIV_H
...
#import <sys/types.h>		/* some systems still require this */
#import <sys/stat.h>
#import <sys/termios.h>	/* for winsize */
#ifndef TIOCGWINSZ
#import <sys/ioctl.h>
#endif
#import <stdio.h>		/* for convenience */
#import <stdlib.h>		/* for convenience */
#import <stddef.h>		/* for offsetof */
#import <string.h>		/* for convenience */
#import <unistd.h>		/* for convenience */
#import <signal.h>		/* for SIG_ERR */
